...
#ID LINE : http://line.me/ti/p/~zul.1.02
            ...
            if wait["autoAdd"] == True:
                if op.param2 not in Bots and op.param2 not in admin:
                    if (wait["message"] in [" "," ","\n",None]):
                        ...
                        cl.sendContact(op.param1, "u1aaf34421b7a8a94e0a977095e4ff605")
                    ...
                    if text is None:
                        ...
                        if cmd == "help":
                          if wait["selfbot"] == True:
                               ...
                               cl.sendContact(to, "u1aaf34421b7a8a94e0a977095e4ff605")
